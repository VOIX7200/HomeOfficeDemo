...
import com.googletest.qa.base.TestBase.BrowserType;
import com.googletest.qa.base.TestBase.BrowserType.browserType;

public class GoogleSearchTest_NO_POM_FluentWait extends TestBase{
	Wait<WebDriver> waitx;
	...
	@BeforeMethod
	public void setUp(){
       browserType btype = browserType.Firefox;		
		//initialise();
		initialiseRemote(btype);
		waitx = new FluentWait<WebDriver>(driver)
	...
	/**	Wait<WebDriver> wait1 = new FluentWait<WebDriver>(driver)
	            ...
	            .ignoring(NoSuchElementException.class);
	            //Note this is not supported by Selenium 3.141.5
	            ***/
		...
		//Locate searchBox 
	WebElement searchchBox = waitx.until(ExpectedConditions.visibilityOfElementLocated(By.name("q")));
