...
//	public void initialise(browserType browser){
	...
	public static void initialiseRemote(browserType browser){
		...
		System.out.println("inside - Docker Selenium_Grid_Firefox - Start");
